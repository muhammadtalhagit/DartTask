...
// Task
// var names={"Talha","Hamza","Farhan","Umais"};

 
//  var Task=new HashMap();

// Task['list']= {1,3,5,7,9,11};
// Task['set']={"Haris","Shakeel","Farrukh","Umair"};
// Task['String']="Muhammad Talha";
// Task['int']=45;
// Task['boolean']= true;//boolean
...
// Task['list']= ['Orange',{"Shakeel","Farrukh"},'Mango'];
// print(Task);
// Task['set']={"Haris","Shakeel","Farrukh","Umair"};
// Task['String']="Muhammad Talha";
// Task['int']=45;
...
//     print('Key: $key'); // Key ko print karenge
//     var value = Task[key];  // Value ko key se access karenge
//     print('Value: $value'); // Value ko print karenge
